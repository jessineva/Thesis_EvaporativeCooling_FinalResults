...
#         self.senPBCafe1_Q12 = self.api.exchange.get_variable_handle(state, mtnQ12, u"NCAFETERIA_VENTANAOESTE")
#         self.senPBCafe1_Q21 = self.api.exchange.get_variable_handle(state, mtnQ21, u"NCAFETERIA_VENTANAOESTE")
#         self.senPBCafe2_Q12 = self.api.exchange.get_variable_handle(state, mtnQ12, u"NCAFETERIA_ENTRADA")
#         self.senPBCafe2_Q21 = self.api.exchange.get_variable_handle(state, mtnQ21, u"NCAFETERIA_ENTRADA")
