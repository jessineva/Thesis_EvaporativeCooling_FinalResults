...
class EvapMistCooling(EnergyPlusPlugin):
    ...
    def get_rel_hum(self, state, Tbs, Tbh, Pb):
        ...
        """
        psychro = self.api.functional.psychrometrics(state)
        return psychro.relative_humidity_b(state, Tbs, psychro.humidity_ratio_d(state, Tbs, Tbh, Pb), Pb)*100
    ...
    def get_handles(self, state):
        ...
        self.senPBCafe1_Q12 = self.api.exchange.get_variable_handle(state, mtnQ12, u"NCAFETERIA_ENTRADA")
        self.senPBCafe1_Q21 = self.api.exchange.get_variable_handle(state, mtnQ21, u"NCAFETERIA_ENTRADA")
...
#         else:
        PBCafe1_Qin = self.api.exchange.get_variable_value(state, self.senPBCafe1_Q21) + self.api.exchange.get_variable_value(state, self.senPBCafe2_Q21) - self.api.exchange.get_variable_value(state, self.senPBCafe1_Q12) - self.api.exchange.get_variable_value(state, self.senPBCafe2_Q12)
